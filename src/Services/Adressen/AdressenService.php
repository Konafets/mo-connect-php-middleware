...
use ArrobaIt\MoConnectApi\Models\ReturnStatus;
...
class AdressenService extends BaseService
{
    ...
    public function adresseKategorieList(): AdresseKategorieItems
    {
        ...
        try {
            ...
            return AdresseKategorieItems::fromResponse(
                $response->adresseKategorieListResponse->ReturnData->AdresseAddItem
            );
        } catch (JsonException | GuzzleException $e) {
        }
    }
     ...
     */
    public function adresseAnsprechpartnerTemplate(string $adresseId = null)
    {
        $request = [
     ...
     */
    public function adresseAnsprechpartnerList(string $adresseId)
    {
        $request = [
     ...
     */
    public function adresseSepaMandatList(string $id)
    {
        $request = [
