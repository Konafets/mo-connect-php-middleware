...
class AdresseAddItem
{
    ...
    public function __construct(
        ...
        // TODO: Check for non empty $matchcode
        ...
        $this->kfPreisangabe = $kfPreisangabe instanceof AdressePreisAngabe ? $kfPreisangabe : new AdressePreisAngabe();
        ...
        $this->kfBankdaten = $kfBankdaten instanceof BankdatenItem ? $kfBankdaten : new BankdatenItem();
        ...
        $this->lfPreisangabe = $lfPreisangabe instanceof AdressePreisAngabe ? $lfPreisangabe : new AdressePreisAngabe();
    ...
    public function __toArray(): array
    {
        return [
            ...
            'KF_Bankdaten' => $this->getKfBankdaten()->__toArray(),
